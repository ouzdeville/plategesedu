...
<body>
  ...
  ?>
    ...
    <form action="traiternote.php?eval=<?php echo $_GET["eval"]?>&ideve=<?php echo $_GET["ideve"] ?>&NOM=<?php	echo $_GET["NOM"]  ?>&semestre=<?php	echo $_GET["semestre"]  ?>&classe=<?php	echo $_GET["classe"]?>&idmatierepromo=<?php echo $_GET["idmatierepromo"] ?>" method="post">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                             ...
                             if ($row1){
                            $request="SELECT r.* FROM reclamation r
